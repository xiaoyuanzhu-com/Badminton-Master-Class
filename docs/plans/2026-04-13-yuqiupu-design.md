# 羽球大师课 (Badminton Master Class) — Design Doc
...
像 Badminton Famly 的结构化体验，但内容来自社区 — Bilibili、小红书、抖音、微信等平台上散落的优质教学内容，被人工精选、按技术分类整理，沉淀成一套可以反复研习的大师课。

短视频平台的内容生命周期很短，好的技术教学被算法淹没。羽球大师课让这些内容沉淀下来，长期可找。
